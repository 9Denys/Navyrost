    ...
    <div class="admin-container">
        <aside class="admin-sidebar">
            ...
            <nav class="admin-nav">
                <ul>
                    ...
                    <li class="active"><a href="<?= $baseUrl ?>/View/ip_validator.php"><i class="fas fa-check-circle"></i> Валідатор IP</a></li>
        ...
        <main class="admin-content">
            ...
            <section class="ip-validation-section">
                <form method="POST" action="<?= $baseUrl ?>/Controller/IpValidatorController.php" class="ip-validation-form">
